...
package cn.kivensoft.qrcode.zxing;
...
public final class Mode {
    ...
    public static final Mode BYTE = new Mode(new int[] { 8, 16, 16 }, 0x04,
            "BYTE");
    public static final Mode ECI = new Mode(0x07, "ECI"); // character counts
                                                          // don't apply
    public static final Mode KANJI = new Mode(new int[] { 8, 10, 12 }, 0x08,
            "KANJI");
    public static final Mode FNC1_FIRST_POSITION = new Mode(0x05,
            "FNC1_FIRST_POSITION");
    public static final Mode FNC1_SECOND_POSITION = new Mode(0x09,
    ...
    private Mode(int bits, String name) {
        characterCountBitsForVersions = null;
        this.bits = bits;
        this.name = name;
    }
