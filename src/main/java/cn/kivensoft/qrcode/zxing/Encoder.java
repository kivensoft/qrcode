...
public final class Encoder {
    ...
    public static void encode(String content, ErrorCorrectionLevel ecLevel,
            ZXingQRCode qrCode) throws WriterException {
    ...
    private static int chooseMaskPattern(BitArray bits,
        ...
        for (int maskPattern = 0; maskPattern < ZXingQRCode.NUM_MASK_PATTERNS; maskPattern++) {
    ...
    private static void initQRCode(int numInputBytes,
            ErrorCorrectionLevel ecLevel, Mode mode, ZXingQRCode qrCode)
            throws WriterException {
